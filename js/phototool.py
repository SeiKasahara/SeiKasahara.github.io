...
config = {
        ...
        'github_img_host_base': '/hexo/Photos1',
        # 会对这个目录下的所有文件夹进行遍历，相同目录生成_samll 的 缩略图
        'img_path':             '/hexo/Photos1/rebootcat/photowall',
        # cdn 前缀
        'cdn_url_prefix':       'https://cdn.jsdelivr.net/gh/SeiKasahara/Photos1',
        # hexo 博客存放 photos 信息的 json 文件
        'photo_info_json':      '/hexo/seikasahara.github.io/source/photos/photoslist.json',
        }
