...
**链条 2：参展门槛使得网络重置。** 线下展会是网络的周期性重置器，把参与者暂时推回近似小世界网络。但重置不是无差别的：**谁参展了，谁就被重置到完全图内**。被高摊位费排斥的用爱发电小社团不参展，就会使得他们的网络位置在线上持续碎片化，而如果恰好声誉低，又会促进边缘化。
